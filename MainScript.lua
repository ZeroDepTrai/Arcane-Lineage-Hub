...
pcall(function()
    if game and game.HttpGet then
        local src = game:HttpGet("https://raw.githubusercontent.com/ZeroDepTrai/ZeroLib-UI/main/ZeroLib.lua?t=" .. tick())
...
if not ZeroLib then
    pcall(function()
        if readfile and isfile and isfile("arcane_hub_custom_ui/ZeroLib.lua") then
            ZeroLib = loadstring(readfile("arcane_hub_custom_ui/ZeroLib.lua"))()
        elseif readfile and isfile and isfile("ZeroLib.lua") then
            ZeroLib = loadstring(readfile("ZeroLib.lua"))()
        elseif loadfile then
            local fn = loadfile("arcane_hub_custom_ui/ZeroLib.lua") or loadfile("ZeroLib.lua")
            if fn then ZeroLib = fn() end
        end
    end)
end
