                        ...
                        if AutoYarthul and AutoYarthul.running then
                            ...
                            pcall(function()
                                ZeroLib:Notify({
                                    ...
                                    Content = string.format("Received item: %s", (title ~= "" and title ~= "Item dropped!") and title or text),
                                    Type = "Success",
                                    Duration = 4
                                })
                            end)
...
function AutoYarthul.createHUD()
    ...
    pcall(function()
        ...
        killLabel.Text = string.format("⚔️ Boss Kills: %d", AutoYarthul.bossKillCount)
...
function AutoYarthul.updateHUD(statusText)
    ...
    pcall(function()
        ...
        if kl then
            kl.Text = string.format("⚔️ Boss Kills: %d", AutoYarthul.bossKillCount)
        end
